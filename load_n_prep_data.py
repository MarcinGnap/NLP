...
def df_cleanup_for_unmerged(merged_df):
...
def df_cleanup_for_merged(merged_df):
    no_duplicates_df = merged_df.drop_duplicates(subset='title', keep='first').copy()
...
def encode_text_unmerged(no_duplicates_df):
...
def encode_text_merged(no_duplicates_df):
